...
contract DroneConsensus {
    ...
    event BlockCommitted(uint256 view, string digest, string operation, uint256 x, uint256 y);
    ...
    function commitBlock(
        ...
        require(bytes(committedBlocks[view]).length == 0, "Already committed");
        committedBlocks[view] = digest;
        emit BlockCommitted(view, digest, operation, x, y);
    }
